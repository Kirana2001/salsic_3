...
@section('content')
	...
	<div class="page-header page-header-light">
		<div class="page-header-content header-elements-md-inline">
			<div class="page-title d-flex">
				<h4><span class="font-weight-semibold">Edit</span> - Jadwal</h4>
	...
	<div class="content">
		...
		<div class="card">
			...
			<div class="card-body">
				<form id="submit-form" class="form-validate-jquery" action="{{url('/jadwal/'.$jadwal->id)}}" method="post" enctype="multipart/form-data">
                    @method('PATCH')
					@csrf
					<fieldset class="mb-3">
                        ...
                        <div class="form-group row">
							...
							<div class="col-lg-10">
                                ...
                                placeholder="Nama Tim 1" required autofocus autocomplete="off" value="{{ $jadwal->tim_a }}">
							</div>
						</div>
                        <div class="form-group row">
							...
							<div class="col-lg-10">
                                ...
                                placeholder="Nama Tim 2" required autofocus autocomplete="off" value="{{ $jadwal->tim_b }}">
							</div>
						</div>
                        <div class="form-group row">
							<label class="col-form-label col-lg-2">Skor 1 <span class="text-danger">*</span> </label>
							<div class="col-lg-10">
								<input type="text" name="skor_a"
                                class="form-control border-blue-700 border-1 @error('skor_a') is-invalid @enderror"
                                placeholder="Nama Tim 1" required autofocus autocomplete="off" value="{{ $jadwal->skor_a }}">
							</div>
						</div>
                        <div class="form-group row">
							<label class="col-form-label col-lg-2">Skor 2 <span class="text-danger">*</span> </label>
							<div class="col-lg-10">
								<input type="text" name="skor_b"
                                class="form-control border-blue-700 border-1 @error('skor_b') is-invalid @enderror"
                                placeholder="Nama Tim 2" required autofocus autocomplete="off" value="{{ $jadwal->skor_b }}">
							</div>
						</div>
                        <div class="form-group row">
							...
							<div class="col-lg-10">
                                ...
                                placeholder="Tempat" required autocomplete="off" value="{{ $jadwal->place }}">
							</div>
						</div>
						<div class="form-group row">
							...
							<div class="col-lg-10">
                                ...
                                placeholder="Tanggal Permainan" required autocomplete="off" value="{{ $jadwal->date }}">
							</div>
						</div>
                        <div class="form-group row">
