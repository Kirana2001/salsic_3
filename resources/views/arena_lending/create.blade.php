	...
	<div class="page-header page-header-light">
		<div class="page-header-content header-elements-md-inline">
			<div class="page-title d-flex">
				<h4><span class="font-weight-semibold">Tambah</span> - Peminjaman Arena</h4>
					...
					<fieldset class="mb-3">
                        ...
                        <div class="form-group row">
							...
							<div class="col-lg-10">
                                ...
                                placeholder="Tanggal Pengajuan" required autofocus autocomplete="off" value="{{ date('Y-m-d') }}">
							</div>
						</div>
                        <div class="form-group row">
							...
							<div class="col-lg-10">
                                ...
                                placeholder="Nama Peminjam" required autofocus autocomplete="off" value="{{ old('name') }}">
							</div>
						</div>
                        <div class="form-group row">
							...
							<div class="col-lg-10">
                                ...
                                placeholder="NIK" required autofocus autocomplete="off" value="{{ old('nik') }}">
							</div>
						</div>
                        <div class="form-group row">
							...
							<div class="col-lg-10">
                                ...
                                placeholder="Telepon" required autofocus autocomplete="off" value="{{ old('phone') }}">
							</div>
						</div>
                        <div class="form-group row">
							...
							<div class="col-lg-10">
                                ...
                                placeholder="Email" required autofocus autocomplete="off" value="{{ old('email') }}">
							</div>
						</div>
                        <div class="form-group row">
                        ...
                        <div class="form-group row">
							...
							<div class="col-lg-10">
                                ...
                                placeholder="Tujuan Peminjaman" required autofocus autocomplete="off" value="{{ old('purpose') }}">
							</div>
						</div>
                        <div class="form-group row">
							...
							<div class="col-lg-10">
                                ...
                                placeholder="Tanggal Awal Peminjaman" required autofocus autocomplete="off" value="{{ date('Y-m-d') }}">
							</div>
						</div>
                        <div class="form-group row">
