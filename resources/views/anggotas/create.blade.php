...
@section('content')
	...
	<div class="page-header page-header-light">
		<div class="page-header-content header-elements-md-inline">
			<div class="page-title d-flex">
				<h4><span class="font-weight-semibold">Tambah</span> - Anggota</h4>
	...
	<div class="content">
		...
		<div class="card">
			...
			<div class="card-body">
				<form id="submit-form" class="form-validate-jquery" action="{{url('/anggotas')}}" method="post" enctype="multipart/form-data">
					@csrf
					<fieldset class="mb-3">
                        ...
                        <div class="form-group row">
							...
							<div class="col-lg-10">
                                ...
                                placeholder="Nama" required autofocus autocomplete="off" value="{{ old('name') }}">
							</div>
						</div>
                        <div class="form-group row">
							...
							<div class="col-lg-10">
                                ...
                                data-dropdown-css-class="border-blue-700" required>
                                    @foreach ($pemudas as $pemuda)
                                        <option value="{{$pemuda->id}}">{{$pemuda->organization_name}}</option>
                                    @endforeach
                                </select>
							</div>
                        </div> --}}
                        ...
                        <div class="form-group row">
							...
							<div class="col-lg-10">
                                ...
                                placeholder="Tanggal Lahir" required autocomplete="off" value="{{ old('tgl_lahir') }}">
							</div>
						</div>
                        <div class="form-group row">
							...
							<div class="col-lg-10">
                                ...
                                placeholder="Tempat Lahir" required autocomplete="off" value="{{ old('tmp_lahir') }}">
							</div>
						</div>
                        <div class="form-group row">
							...
							<div class="col-lg-10">
                                ...
                                placeholder="Telpon" required autocomplete="off" value="{{ old('telp') }}">
							</div>
						</div>
                        <div class="form-group row">
							...
							<div class="col-lg-10">
                                ...
                                placeholder="Alamat" required autocomplete="off" cols="30" rows="5">{{ old('alamat_ktp') }}</textarea>
							</div>
						</div>
                        <div class="form-group row">
							...
							<div class="col-lg-10">
                                ...
                                placeholder="Alamat" required autocomplete="off" cols="30" rows="5">{{ old('alamat_domisili') }}</textarea>
							</div>
						</div>
                        <div class="form-group row">
							...
							<div class="col-lg-10">
                                ...
                                placeholder="Kelurahan" required autocomplete="off" value="{{ old('kelurahan') }}">
							</div>
						</div>
                        <div class="form-group row">
							...
							<div class="col-lg-10">
                                ...
                                placeholder="Kecamatan" required autocomplete="off" value="{{ old('kecamatan') }}">
							</div>
						</div>
                        <div class="form-group row">
							...
							<div class="col-lg-10">
                                ...
                                placeholder="Pekerjaan" required autocomplete="off" value="{{ old('pekerjaan') }}">
							</div>
						</div>
                        <div class="form-group row">
                        ...
                        <div class="form-group row">
							...
							<div class="col-lg-10">
                                ...
                                placeholder="Instagram"autocomplete="off" value="{{ old('instagram') }}">
							</div>
						</div>
                        <div class="form-group row">
							...
							<div class="col-lg-10">
                                ...
                                placeholder="Youtube"autocomplete="off" value="{{ old('youtube') }}">
							</div>
						</div>
                        <div class="form-group row">
							...
							<div class="col-lg-10">
                                ...
                                placeholder="Twitter"autocomplete="off" value="{{ old('twitter') }}">
							</div>
						</div>
                        <div class="form-group row">
							...
							<div class="col-lg-10">
                                ...
                                placeholder="Facebook"autocomplete="off" value="{{ old('facebook') }}">
							</div>
						</div>
