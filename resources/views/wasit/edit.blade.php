...
@section('content')
	...
	<div class="page-header page-header-light">
		<div class="page-header-content header-elements-md-inline">
			<div class="page-title d-flex">
				<h4><span class="font-weight-semibold">Edit</span> - Wasit</h4>
	...
	<div class="content">
		...
		<div class="card">
			...
			<div class="card-body">
				<form id="submit-form" class="form-validate-jquery" action="{{url('wasit/'.$wasit->id)}}" method="post" enctype="multipart/form-data">
                    @method('PATCH')
					@csrf
					<fieldset class="mb-3">
                        ...
                        <div class="form-group row">
							...
							<div class="col-lg-10">
                                ...
                                placeholder="Nama" required autofocus autocomplete="off" value="{{ $wasit->name }}">
							</div>
						</div>
                        <div class="form-group row">
							...
							<div class="col-lg-10">
                                ...
                                placeholder="NIK" required autofocus autocomplete="off" value="{{ $wasit->nik }}">
							</div>
						</div>
                        <div class="form-group row">
                                ...
                                data-dropdown-css-class="border-blue-700" required>
                                    ...
                                    @foreach ($cabors as $cabor)
                                        <option value="{{$cabor->id}}"
                                            {{$wasit->cabor_id == $cabor->id ? 'selected' : ''}}>{{$cabor->name}}</option>
                                    @endforeach
                                </select>
							</div>
                        </div>
                        <div class="form-group row">
							...
							<div class="col-lg-10">
                                ...
                                placeholder="Tempat Lahir" required autocomplete="off" value="{{ $wasit->birth_place }}">
							</div>
						</div>
						<div class="form-group row">
							...
							<div class="col-lg-10">
                                ...
                                placeholder="Tanggal Lahir" required autocomplete="off" value="{{ $wasit->birth_date }}">
							</div>
						</div>
                        <div class="form-group row">
							...
							<div class="col-lg-10">
                                ...
                                placeholder="Alamat" required autocomplete="off" cols="30" rows="5">{{ $wasit->address }}</textarea>
							</div>
						</div>
                        <div class="form-group row">
							...
							<div class="col-lg-10">
                                ...
                                placeholder="Telepon" required autocomplete="off" value="{{ $wasit->phone }}">
							</div>
						</div>
                        <div class="form-group row">
