...
@section('content')
	...
	<div class="content">
		...
		<div class="card">
			...
			<div class="card-body">
				<form id="submit-form" class="form-validate-jquery" action="{{url('atlets/'.$atlet->id)}}" method="post" enctype="multipart/form-data">
                    @method('PATCH')
					@csrf
					<fieldset class="mb-3">
                        ...
                        <div class="form-group row">
							...
							<div class="col-lg-10">
                                ...
                                placeholder="Nama" required autofocus autocomplete="off" value="{{ $atlet->name }}">
							</div>
						</div>
                        <div class="form-group row">
							...
							<div class="col-lg-10">
                                ...
                                placeholder="NIK" required autofocus autocomplete="off" value="{{ $atlet->nik }}">
							</div>
						</div>
                        <div class="form-group row">
                        ...
                        <div class="form-group row">
							...
							<div class="col-lg-10">
                                ...
                                placeholder="Tempat Lahir" required autocomplete="off" value="{{ $atlet->birth_place }}">
							</div>
						</div>
						<div class="form-group row">
							...
							<div class="col-lg-10">
                                ...
                                placeholder="Tanggal Lahir" required autocomplete="off" value="{{ $atlet->birth_date }}">
							</div>
						</div>
                        <div class="form-group row">
							...
							<div class="col-lg-10">
                                ...
                                placeholder="Alamat" required autocomplete="off" cols="30" rows="5">{{ $atlet->address }}</textarea>
							</div>
						</div>
                        <div class="form-group row">
