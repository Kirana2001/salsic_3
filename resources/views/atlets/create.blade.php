...
@section('content')
	...
	<div class="page-header page-header-light">
		<div class="page-header-content header-elements-md-inline">
			<div class="page-title d-flex">
				<h4><span class="font-weight-semibold">Tambah</span> - Atlet</h4>
	...
	<div class="content">
		...
		<div class="card">
			...
			<div class="card-body">
				<form id="submit-form" class="form-validate-jquery" action="{{url('/atlets')}}" method="post" enctype="multipart/form-data">
					@csrf
					<fieldset class="mb-3">
                        ...
                        <div class="form-group row">
							<label class="col-form-label col-lg-2">No KTP <span class="text-danger">*</span> </label>
							<div class="col-lg-10">
								<input type="text" name="nik"
                                class="form-control border-blue-700 border-1 @error('nik') is-invalid @enderror"
                                placeholder="No KTP" required autofocus autocomplete="off" value="{{ old('nik') }}">
							</div>
						</div>
                        <div class="form-group row">
							...
							<div class="col-lg-10">
                                ...
                                placeholder="No KK" required autofocus autocomplete="off" value="{{ old('no_kk') }}">
							</div>
						</div>
                        <div class="form-group row">
                        ...
                        <div class="form-group row" id="addCaborDiv">
							...
							<div class="col-lg-10">
                                ...
                                placeholder="Tambah Cabor" required autocomplete="off" value="{{ old('addCabor') }}">
							</div>
						</div>
                        <div class="form-group row">
							...
							<div class="col-lg-10">
                                ...
                                placeholder="Tempat Lahir" required autocomplete="off" value="{{ old('birth_place') }}">
							</div>
						</div>
						<div class="form-group row">
							...
							<div class="col-lg-10">
                                ...
                                placeholder="Tanggal Lahir" required autocomplete="off" value="{{ old('birth_date') }}">
							</div>
						</div>
                        <div class="form-group row">
                        ...
                        <div class="form-group row">
							...
							<div class="col-lg-10">
                                ...
                                placeholder="Telepon" required autocomplete="off" value="{{ old('phone') }}">
							</div>
						</div>
                        <div class="form-group row">
                        ...
                        <div class="form-group row">
							...
							<div class="col-lg-10">
                                ...
                                placeholder="No Rekening" required autocomplete="off" value="{{ old('no_rek') }}">
							</div>
						</div>
                        <div class="form-group row">
							...
							<div class="col-lg-10">
                                ...
                                placeholder="Nama Bank" required autocomplete="off" value="{{ old('bank') }}">
							</div>
						</div>
                        <div class="form-group row">
							...
							<div class="col-lg-10">
                                ...
                                placeholder="Lini" required autocomplete="off" value="{{ old('lini') }}">
							</div>
						</div>
                        <div class="form-group row">
							...
							<div class="col-lg-10">
                                ...
                                placeholder="Klasifikasi" required autocomplete="off" value="{{ old('klasifikasi') }}">
							</div>
						</div>
                        <div class="form-group row">
